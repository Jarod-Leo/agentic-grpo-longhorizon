"""Evaluation instrumentation around the unchanged training interaction loop."""
...
def append_record(record):
    ...
    with open(os.environ["E00_TRAJECTORIES_PATH"], "a", encoding="utf-8") as stream:
        stream.write(json.dumps(record, ensure_ascii=False) + "\n")


class BaselineEvalAgentLoop(AuditedToolAgentLoop):
